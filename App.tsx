...
const VIEW_META: Record<ViewState, { title: string; subtitle: string }> = {
  ...
  [ViewState.COMPETITOR_ANALYSIS]:{ title: 'Market Analysis',        subtitle: 'Visualize risk metrics and compare vendor performance.' },
  [ViewState.REQUEST_LAB_VISIT]: { title: 'Emerging Tech Lab',       subtitle: 'Schedule hands-on evaluation time in the secure lab.' },
  [ViewState.COMPETITOR_INTEL]:  { title: 'Competitor Intelligence', subtitle: 'Analyst-enriched competitor events across retail.' },
  ...
  [ViewState.REGULATORY_INTEL]:  { title: 'Regulatory Intelligence', subtitle: 'Obligations across AI, Biometrics, ALPR, UAS & Data Privacy.' },
